...
class TwigExtension extends \Twig_Extension implements \Twig_ExtensionInterface {
  ...
  public function getFunctions() {
    ...
    $return = [
      ...
      new \Twig_SimpleFunction('drupal_entity', [$this, 'drupalEntityFunction']),
    ];
  ...
  public function getFilters() {
    ...
    $return[] = new \Twig_SimpleFilter('shuffle', [$this, 'shuffle_filter']);
    $return[] = new \Twig_SimpleFilter('value', [$this, 'valueFilter']);
    $return[] = new \Twig_SimpleFilter('image_style', [$this, 'imageStyle']);
    return $return;
  }
  ...
  /**
   * Render any content entity known to the system
   *  {{ drupal_entity('media', 123, 'slider') }}
   */
  public function drupalEntityFunction($entity_type, $id = NULL, $view_mode = NULL, $check_access = TRUE, $langcode = NULL) {
  ...
  /**
   * Apply a image style to any file that is accessable within the system
   */
  public function imageStyle($path, $style) {
    if ($image_style = ImageStyle::load($style) && $image_style->supportsUri($path)) {
